...
We use Classification And Regression Tree (CART), aiming for

- investigating the feasibility of using the Classification and Regression Tree (CART) algorithm in SWC estimation
- training and validation of CART models using **meteorological data**^[such as precipitation, air temperature and pressure] from a grassland terrain in northern Taiwan

### Why we choose CART

- In soil water estimation, the top-performing models are mostly 
  - Artificial Neural Network (ANN) 
  - CART-based models, such as Random Forest, Gradient Boosted Trees
- Intrinsic ability for feature selection
...
We examine the results of feature analysis using CART's feature importance metrics:
...
- Random Forest brings minor but comprehensive improvements.
- Feature importance analysis can be used to quantify the responsiveness of SWC to specific meteorological parameters.
